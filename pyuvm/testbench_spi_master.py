...
class SeqItem(uvm_sequence_item):
    ...
    def __init__(self, name, i_en,i_tx_data):
        super().__init__(name)
        self. i_en = i_en
...
class RandomSeq(uvm_sequence):
    ...
    async def body(self):
        while(len(covered_values) != 2**g_width):
            ...
            await RisingEdge(cocotb.top.f_execute_ready)
...
class Driver(uvm_driver):
    ...
    async def run_phase(self):
        ...
        while True:
            ...
            await self.bfm.send_data((data.i_en,data.i_crv.tx_data))
        ...
        while self.result_get_port.can_get():
            ...
            if not data_success:
                ...
                if(old_rx_data != rx_data):
                    print("old data {} new data{} and actual_result is {}".format(int(old_rx_data),int(rx_data),int(i_tx_data)))
